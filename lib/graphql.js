...
const schema = buildSchema(`
    type Query {
        ...
        testSlack(command: String!, game_id: Int!, min_units: Int!, territories_per_unit: Int!, args: [String!]!): String!
    }
    type Player {
        name: String!
        profile_id: String!
...
const root = {
    ...
    testSlack: async (args) => {
        const obj = await SlackCommands.run(args.command, args);
